...
- Name: modal.spec.js >> wc-modal A11y tests >> MD-06-B Tab moves focus forward
- Location: tests/modal.spec.js:87:3
...
Locator:  getByRole('button', { name: /close/i })
Expected: focused
Received: inactive
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /close/i })
    14 × locator resolved to <button id="close" command="close" commandfor="modal-dialog">Close</button>
